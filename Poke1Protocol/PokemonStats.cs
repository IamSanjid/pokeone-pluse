...
namespace Poke1Protocol
{
    public class PokemonStats
    {
        ...
        public PokemonStats(PSXAPI.Response.Payload.BattlePokemonStats stats, int hp)
        {
            Health = hp;
            Attack = stats.atk;
            SpAttack = stats.spa;
        ...
        internal PokemonStats(PSXAPI.Response.Payload.PokemonStats stats)
        {
            Health = stats.HP;
            Attack = stats.Atk;
            SpAttack = stats.SpAtk;
            SpDefence = stats.SpDef;
            Speed = stats.Speed;
            Defence = stats.Def;
        }
